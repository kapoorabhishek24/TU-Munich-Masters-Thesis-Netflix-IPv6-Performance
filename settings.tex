...
\usepackage[font=small, labelfont=bf, textfont=it, figurename=Fig.]{caption}
\renewcommand{\figurename}{Fig.}
\usepackage[hidelinks, colorlinks=true, linkcolor=black]{hyperref} % hidelinks removes colored boxes around references and links
